...
- 如果你希望贡献 Rating 算法：
  ...
  - 当前计算规则：
    ...
    其中对于比赛, $F = 50, P = 2$, 对于作业/训练, $F = 110, P= 1.2$.
    ...
    $$
    T(x) = \\begin{cases} 3 & x = 1, \\\\ 2 & x = 2, \\\\ 1.2 & x = 3, \\\\ 0 & x \\ge 4. \\end{cases}
    $$

    设 $x$ 是在 $g$ 小组中的一个人. ta 参与的全体比赛组成的集合为 $T_1$, 对于一个比赛 $c$, 我们定义 $\\operatorname{rank}_c x$ 是 $x$ 在 $c$ 比赛排名. 则 $x$ 的前三加分为:

    $$
    R_3 = \\sum_{t \\in T_1} T\\left(\\operatorname{rank}_c x\\right) N^{0.8}(g),
    $$
